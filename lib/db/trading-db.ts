...
const CONFIG_METADATA: Record<string, ConfigMeta> = {
  ...
  'strategy_specific.spread_based.enable_spread_monitoring': { type: 'boolean', category: 'ai', group: '3. Spread-Based Strategy Settings', description: 'Enable spread monitoring', tooltip: 'Current: true | Monitor spread volatility and mean reversion for position management', order: 23 },
  'strategy_specific.spread_based.z_score_monitoring_interval': { type: 'number', category: 'ai', group: '3. Spread-Based Strategy Settings', description: 'Monitoring interval (seconds)', tooltip: 'Current: 60 | Check z-score every N seconds for exit signals. Lower = more responsive. Range: 10-300', order: 24 },
  'strategy_specific.spread_based.spread_reversion_threshold': { type: 'number', category: 'ai', group: '3. Spread-Based Strategy Settings', description: 'Reversion threshold', tooltip: 'Current: 0.1 | Threshold for detecting mean reversion in spread. Range: 0.05-0.5', order: 25 },
  'strategy_specific.spread_based.max_spread_deviation': { type: 'number', category: 'ai', group: '3. Spread-Based Strategy Settings', description: 'Max spread deviation', tooltip: 'Current: 3.0 | Maximum z-score deviation before force-closing position. Range: 2.0-5.0', order: 26 },
