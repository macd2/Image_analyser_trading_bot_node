  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm">
      <div className="bg-slate-800 border border-slate-600 rounded-lg shadow-2xl w-full max-w-6xl max-h-[90vh] flex flex-col">
        ...
        {/* Footer - 4 Action Buttons (ALWAYS ACTIVE AND FUNCTIONAL - NO DISABLED STATE) */}
        <div className="p-4 border-t border-slate-600">
          <div className="grid grid-cols-2 gap-3 mb-3">
            {/* Button 1: Start VNC - ALWAYS ACTIVE */}
            <button
              onClick={handleStartVnc}
              className="flex items-center justify-center gap-2 px-4 py-3 bg-blue-600 hover:bg-blue-700 rounded-lg transition text-white font-medium"
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-3 bg-purple-600 hover:bg-purple-700 rounded-lg transition text-white font-medium"
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-3 bg-green-600 hover:bg-green-700 rounded-lg transition text-white font-medium"
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-3 bg-red-600 hover:bg-red-700 rounded-lg transition text-white font-medium"
